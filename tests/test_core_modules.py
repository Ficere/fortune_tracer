...
class TestCacheModule:
    ...
    def test_simple_cache_creation(self):
        """测试缓存创建"""
        from src.core.utils.cache import SimpleCache
    ...
    def test_cached_decorator(self):
        """测试缓存装饰器"""
        from src.core.utils.cache import cached, clear_cache
...
class TestExceptionsModule:
    ...
    def test_fortune_tracer_error(self):
        """测试基础异常"""
        from src.core.utils.exceptions import FortuneTracerError
    ...
    def test_pillar_calculation_error(self):
        """测试四柱计算错误"""
        from src.core.utils.exceptions import PillarCalculationError
...
class TestLoggingModule:
    ...
    def test_logger_mixin(self):
        """测试日志混入类"""
        from src.core.utils.logging import LoggerMixin
...
class TestNayinModule:
    ...
    def test_all_60_jiazi(self):
        """测试60甲子纳音完整性"""
        from src.core.bazi.nayin import JIAZI_NAYIN

        assert len(JIAZI_NAYIN) == 60

    def test_nayin_wuxing_mapping(self):
        """测试纳音五行映射"""
        from src.core.bazi.nayin import get_nayin_wuxing, NAYIN_WUXING
